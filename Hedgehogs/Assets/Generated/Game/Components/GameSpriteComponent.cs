...
// </auto-generated>
//------------------------------------------------------------------------------
public partial class GameEntity : ISpriteEntity { }
...
public partial class GameEntity {
    ...
    public Assets.Scripts.Features.Game.Sprite.SpriteComponent sprite { get { return (Assets.Scripts.Features.Game.Sprite.SpriteComponent)GetComponent(GameComponentsLookup.Sprite); } }
    public bool hasSprite { get { return HasComponent(GameComponentsLookup.Sprite); } }

    public void AddSprite(int newSpriteSortingOrder) {
        var index = GameComponentsLookup.Sprite;
        var component = (Assets.Scripts.Features.Game.Sprite.SpriteComponent)CreateComponent(index, typeof(Assets.Scripts.Features.Game.Sprite.SpriteComponent));
        component.spriteSortingOrder = newSpriteSortingOrder;
        AddComponent(index, component);
    }

    public void ReplaceSprite(int newSpriteSortingOrder) {
        var index = GameComponentsLookup.Sprite;
        var component = (Assets.Scripts.Features.Game.Sprite.SpriteComponent)CreateComponent(index, typeof(Assets.Scripts.Features.Game.Sprite.SpriteComponent));
        component.spriteSortingOrder = newSpriteSortingOrder;
